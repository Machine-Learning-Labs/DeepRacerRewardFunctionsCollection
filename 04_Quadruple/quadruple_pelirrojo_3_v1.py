...
def reward_function(params):
    ...
    # Constants¡
    ABS_STEERING_THRESHOLD = 15 # Steering penality threshold, change the number based on your action space setting
    REWARD_MAX = 1e5
    REWARD_MIN = -1e5
    ...
    if progress >= 99:
        ...
        reward *= REWARD_MAX * (progress / 100)
